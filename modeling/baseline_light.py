...
from .backbones.resnext import build_resnext_backbone
from .backbones.resnext_light import build_resnext_light_backbone
...
class Baseline_light(nn.Module):
    ...
    def __init__(self, num_classes, last_stride, model_path, neck, neck_feat, model_name, pretrain_choice):
        ...
        if model_name == 'resnet18':
            ...
            self.base = build_resnext_backbone(last_stride, 
                                               bn_norm='BN', 
                                               with_ibn=True, 
                                               with_nl=True, 
                                               depth='101x')
        elif model_name == "resnext101_light":
            self.base = build_resnext_light_backbone(last_stride, 
                                               bn_norm='BN', 
                                               with_ibn=True, 
                                               with_nl=True, 
                                               depth='101x')
