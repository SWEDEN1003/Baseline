...
class ResNeXt(nn.Module):
    ...
    def __init__(self, last_stride, bn_norm, with_ibn, with_nl, block, layers, non_layers,
        ...
        self.coord0 = CoordAtt(512, 512)
        self.coord1 = CoordAtt(1024, 1024)
        self.coord2 = CoordAtt(2048, 2048)
    ...
    def load_param(self, model_path):
        print("=====>暂时停用pretrain model<=====")
        ...
    
def build_resnext_light_backbone(last_stride, bn_norm, with_ibn, with_nl, depth='50x'):
    """
